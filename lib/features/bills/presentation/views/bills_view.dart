...
import 'package:smart_city/core/helper/get_it.dart' as di; // تأكد إن الـ alias موجود
...
class BillsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      // تم التعديل هنا: نستخدم getIt<BillsCubit>() بدل BillsRepoImpl
      create: (_) => di.getIt<BillsCubit>()..getMyBills(1), // تحميل الفواتير فور الدخول
      child: Scaffold(
